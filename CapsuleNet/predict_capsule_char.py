...
if __name__ == "__main__":
    with open('tokenizer_char.pickle', 'rb') as handle:
        ...
        submit = pd.read_csv("/data1/hjw/fine_grit_emotion_analysis/testA/ai_challenger_sentiment_analysis_testa_20180816/sentiment_analysis_testa.csv")
        submit_prob = pd.read_csv("/data1/hjw/fine_grit_emotion_analysis/testA/ai_challenger_sentiment_analysis_testa_20180816/sentiment_analysis_testa.csv")

        model1 = TextClassifier().model(embeddings_matrix, maxlen, word_index, 4)
        model1.load_weights(model_dir + "model_ltc_23.hdf5")
        ...
        model2.load_weights(model_dir + "model_ldfbd_23.hdf5")
        ...
        model3.load_weights(model_dir + "model_letf_23.hdf5")
        ...
        model4.load_weights(model_dir + "model_swt_23.hdf5")
        ...
        model5.load_weights(model_dir + "model_swa_23.hdf5")
        ...
        model6.load_weights(model_dir + "model_spc_23.hdf5")
        ...
        model7.load_weights(model_dir + "model_ssp_23.hdf5")
        ...
        model8.load_weights(model_dir + "model_pl_23.hdf5")
        ...
        model9.load_weights(model_dir + "model_pce_23.hdf5")
        ...
        model10.load_weights(model_dir + "model_pd_23.hdf5")
        ...
        model11.load_weights(model_dir + "model_ed_23.hdf5")
        ...
        model12.load_weights(model_dir + "model_en_23.hdf5")
        ...
        model13.load_weights(model_dir + "model_es_23.hdf5")
        ...
        model14.load_weights(model_dir + "model_ec_23.hdf5")
        ...
        model15.load_weights(model_dir + "model_dp_23.hdf5")
        ...
        model16.load_weights(model_dir + "model_dt_23.hdf5")
        ...
        model17.load_weights(model_dir + "model_dl_23.hdf5")
        ...
        model18.load_weights(model_dir + "model_dr_23.hdf5")
        ...
        model19.load_weights(model_dir + "model_ooe_23.hdf5")
        ...
        model20.load_weights(model_dir + "model_owta_23.hdf5")
        ...
        submit.to_csv("baseline_capsule_char.csv", index=None)
        submit_prob.to_csv("baseline_capsule_char_prob.csv", index=None)
